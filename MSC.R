...
errors_list = lapply(horizons, function(h){
  lapply(models_list, function(x)x[,h]-yout[,1])
})
...
MCSprocedure(errors_h1, alpha = 0.90, B = 10000, cl = NULL,
...
MCSprocedure(errors_h3, alpha = 0.90, B = 10000, cl = NULL,
             ram.allocation = TRUE, statistic = "Tmax", k = NULL, min.k = 3,
             verbose = TRUE)
...
MCSprocedure(errors_h6, alpha = 0.90, B = 10000, cl = NULL,
             ram.allocation = TRUE, statistic = "Tmax", k = NULL, min.k = 3,
             verbose = TRUE)
...
MCSprocedure(errors_h12, alpha = 0.15, B = 10000, cl = NULL,
             ram.allocation = TRUE, statistic = "Tmax", k = NULL, min.k = 3,
             verbose = TRUE)
